...
### start of git branch in prompt config ###
setopt prompt_subst
...
# Custom Aliases
alias night-light="redshift -P -O 4000"
alias normal-light="redshift -x"
...
# nvm-zsh -> lazy loading nvm config to improve startup performance
